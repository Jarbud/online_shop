                ...
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="login.html">Barang</a>
                                </li>
                                <li>
                                    <a href="register.html">Info Pembayaran</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
                ...
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="http://localhost/online_shop/login.html">Barang</a>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href='' class="btn btn-primary btn-sm">
                                                        <li class='fa fa-edit'></li>Update
                                                    </a>
                                                    <a href='' class="btn btn-warning btn-sm delete-link">
                        ...
                        <!-- ahkir tabel -->
                        <!-- modal gambar tabel -->
                        <div class="modal fade" id="zoom-gambar" role="dialog">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="image"><img src="../images/bg-title-01.jpg" alt="dummy"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <!-- ahkir modal gambar tabel -->
                        <div class="row">
                            <div class="col-md-12">
                                <div class="copyright">
